...
void DENSEGraph::performMap() {
    ...
    // SPDLOG_INFO("Mini-batch vertex count: {}", node_ids_.size(0));
    // vSPDLOG_INFO("Mini-batch in edge count: {}", dst_sorted_edges_.size(0));
    // SPDLOG_INFO("Mini-batch out edge count: {}", src_sorted_edges_.size(0));
    // SPDLOG_INFO("Mini-batch in edge tensor size (bytes): {}", dst_sorted_edges_.nbytes());
    // SPDLOG_INFO("Mini-batch out edge tensor size (bytes): {}", src_sorted_edges_.nbytes());
