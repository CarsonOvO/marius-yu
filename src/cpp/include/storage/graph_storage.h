...
class GraphModelStorage {
   ...
   public:
    ...
    torch::Tensor gpu_node_features_;
    torch::Tensor gpu_node_embeddings_;
    bool gpu_features_verified_ = false;
    bool features_loaded_to_gpu_ = false;
    bool embeddings_loaded_to_gpu_ = false;
    ...
    std::shared_ptr<StorageConfig> config_;
    bool prefetch_;
